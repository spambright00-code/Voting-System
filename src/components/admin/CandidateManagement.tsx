...
import { Trash2, UploadCloud, ImageIcon, AlertCircle, Edit } from 'lucide-react';
                   ...
                   <div key={candidate.id} className="bg-white rounded-lg border shadow-sm p-4 relative group">
                      {electionPhase === ElectionPhase.SETUP && (
                        <div className="absolute top-2 right-2 hidden group-hover:flex gap-1">
                           <button onClick={() => handleEditClick(candidate)} className="p-1.5 bg-white text-indigo-600 border rounded shadow-sm"><Edit className="w-3 h-3" /></button>
